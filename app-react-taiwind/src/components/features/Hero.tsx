...
export const Hero: FC = () => {
  return (
    <section id="hero" className="min-h-screen flex flex-col items-center justify-center px-6 text-center bg-cream bg-radial-at-t from-white/60 to-transparent">
